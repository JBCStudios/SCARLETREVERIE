        ...
        <div className="container backdrop-blur-sm">
          ...
          >
            <div className="flex justify-center space-x-8 mb-8">
              <SocialLink href="#" label="Instagram" className="text-4xl">
              ...
              <SocialLink href="#" label="TikTok" className="text-4xl">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
              ...
              <SocialLink href="#" label="Facebook" className="text-4xl">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </SocialLink>
              <SocialLink href="#" label="Twitter" className="text-4xl">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-gray-300">
              ...
              <a href="mailto:contact@scarletreverie.com" className="text-scarlet hover:text-scarlet/80 transition-colors">
                contact@scarletreverie.com
              </a>
            </div>
          </motion.div>
        </div>
            ...
            >
              ...
              <div className="prose prose-invert max-w-none">
                <p className="text-gray-300 mb-4">
                  Scarlet Reverie emerges from Toronto's vibrant music scene as a female-fronted progressive rock powerhouse. The band's unique sound bridges the gap between modern progressive complexity and nostalgic 90s rock energy.
                </p>
                <p className="text-gray-300 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                <a 
                  href="mailto:contact@scarletreverie.com" 
...
function SocialLink({ href, label, children, className = '' }: { href: string; label: string; children: React.ReactNode; className?: string }) {
  const isTouch = useIsTouchDevice();
